...
class UrbanIssuesCard extends StatelessWidget {
  final List<Issue> issues;
  final bool isLoading;

  const UrbanIssuesCard({
    super.key,
          ...
          children: [
            Row(
              ...
              children: [
                const Row(
                  children: [
                    Icon(Icons.construction, color: Color(0xFFFF9800), size: 24),
                    SizedBox(width: 8),
                    Text(
                      'Urban Issues',
                      style: TextStyle(
            ...
            if (issues.isEmpty) ...[
              ...
              if (issues.length > 3) ...[
                ...
                Center(
                  child: TextButton(
                    onPressed: () {
                      // TODO: Navigate to all urban issues
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('View all urban issues - Coming Soon')),
                      );
                    },
                    child: Text(
